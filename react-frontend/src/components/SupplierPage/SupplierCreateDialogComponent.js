...
const SupplierCreateDialogComponent = (props) => {
    ...
    return (
        <Dialog header="Create" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div role="supplier-create-dialog-component">
                <div>
                    <p className="m-0" >supplierId:</p>
                    <InputText type="number" className="w-full mb-3" value={_entity?.supplierId} onChange={(e) => setValByKey("supplierId", e.target.value)}  />
                </div>
                <div>
